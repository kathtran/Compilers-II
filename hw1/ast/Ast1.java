...
public class Ast1 {
  ...
  public static class Func extends Node {
    ...
    public final Param[] params;  // formal parameters
    public final VarDecl[] vars;   // local variables
    public final Stmt[] stmts;	   // func body

    public Func(Type rt, String n, Param[] fa, VarDecl[] va, Stmt[] sa) {
      t=rt; nm=n; params=fa; vars=va; stmts=sa;
    }
    public Func(Type rt, String nm, List<Param> fl, List<VarDecl> vl, List<Stmt> sl) {
      this(rt, nm, fl.toArray(new Param[0]), 
