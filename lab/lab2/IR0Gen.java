...
class IR0Gen {
  ...
  static List<IR0.Inst> gen(Ast0.Assign n) throws Exception {
    ...
    // ... need code ...
    CodePack rhsCodePack = gen(n.rhs);
    code.addAll(rhsCodePack.code);
    code.add(new IR0.Move(new IR0.Id(n.lhs.nm), rhsCodePack.src));
    return code;
  }
  ...
  static CodePack gen(Ast0.BoolLit n) throws Exception {
    ...
    // ... need code ...
    /*IR0.Src src = new IR0.BoolLit(n);
    List<IR0.Inst> code = gen(n);
